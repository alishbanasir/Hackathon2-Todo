...
**AI-powered conversational interface for natural language todo management with Kubernetes infrastructure**
...
- **Helm**: Umbrella chart with subcharts for streamlined deployments
- **AI Ops**: kubectl-ai and kagent documentation
...
make build load-minikube deploy-k8s

# Option 3: Kubernetes with Helm (recommended)
make build load-minikube deploy-helm
...
```
phase-4/
├── backend/              # FastAPI backend with Dockerfile
├── frontend/             # Next.js frontend with Dockerfile
...
│   │   └── kagent/       # Example kagent agent
│   └── overlays/         # Environment overlays
│       ├── dev/          # Development overrides
│       └── staging/      # Staging overrides
├── charts/               # Helm charts
│   └── todo-app/         # Umbrella chart
│       ├── charts/       # Subcharts (backend, frontend, postgresql)
...
- [Minikube Setup](docs/minikube-setup.md) - Cluster configuration
- [Deployment Guide](docs/deployment-guide.md) - Full operational runbook
- [kubectl-ai Guide](docs/kubectl-ai-guide.md) - Natural language ops
- [kagent Guide](docs/kagent-guide.md) - Autonomous cluster management

---

## 📖 Overview (Phase 3 Application)
