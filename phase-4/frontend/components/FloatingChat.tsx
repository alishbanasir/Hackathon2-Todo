...
// AI Chatbot API URL — uses same backend as the rest of the app
const API_URL = process.env.NEXT_PUBLIC_API_URL || "http://localhost:8000/api/v1";
const AI_CHAT_API = `${API_URL}/chat/chat`;
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        // Reset conversation on 403 (user doesn't own this conversation)
